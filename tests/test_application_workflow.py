...
def test_build_private_view_url_quotes_application_id():
    assert build_private_view_url("http://192.168.50.109/file-exchange/", "104_8abcd_程式") == "http://192.168.50.109/file-exchange/package?applicationId=104_8abcd_%E7%A8%8B%E5%BC%8F"
